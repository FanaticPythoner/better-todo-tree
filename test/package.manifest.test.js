...
QUnit.test( 'issue #110 highlight colour scheme is opt-in in both namespaces', function( assert )
{
    ...
    assert.strictEqual( legacyUseColourScheme.default, false );
...
QUnit.test( 'streaming ripgrep output exposes no inert buffer-size setting', function( assert )
{
    ...
    assert.false( Object.prototype.hasOwnProperty.call( configurationProperties, 'todo-tree.ripgrep.ripgrepMaxBuffer' ) );
    ...
    assert.strictEqual( readme.indexOf( 'ripgrepMaxBuffer' ), -1 );

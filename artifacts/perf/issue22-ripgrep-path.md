...
| Host | Load Average | 5.05, 4.33, 3.72 |
...
| Memory | Total RAM | 62.51 GiB (`67,119,759,360 bytes`) |
| Memory | Available At Collection | 20.11 GiB (`21,595,205,632 bytes`) |
| Memory | Online Physical RAM | 66.00 GiB (`70,866,960,384 bytes`) |
| Memory | Swap | total 120 GiB (`128,848,973,824 bytes`); free 91.54 GiB (`98,287,824,896 bytes`) |
...
| --- | --- | --- | --- | --- |
| config-ripgrep-path-resolution | microbenchmark | - | Cold config.ripgrepPath resolution with changing VS Code app roots. | One configured miss and one packaged ripgrep hit per operation. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| config-ripgrep-path-resolution | microbenchmark | 6.62 | 11.39 | 8 | 15.71 | 8.06 | 15.75 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| config-ripgrep-path-resolution | microbenchmark | 0 | 0 | 0.13 | 0.13 | 0.13 | 0.25 | 0.25 | 11.63 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| config-ripgrep-path-resolution | microbenchmark | 68.81 | 68.06 | 68.81 | 68.31 | 68.81 | 68.31 | 68.81 | 68.31 |

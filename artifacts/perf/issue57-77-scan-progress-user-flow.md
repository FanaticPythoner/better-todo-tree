...
| Host | Load Average | 3.54, 3.33, 3.17 |
...
| Memory | Available At Collection | 11.41 GiB (`12,253,724,672 bytes`) |
| Memory | Online Physical RAM | 66.00 GiB (`70,866,960,384 bytes`) |
| Memory | Swap | total 120 GiB (`128,848,973,824 bytes`); free 114 GiB (`122,032,443,392 bytes`) |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| workspace-default-relative-rebuild-visible-tree | user-flow | 7.24 | 1.67 | 9.12 | 1.91 | 10.87 | 2.1 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| workspace-default-relative-rebuild-visible-tree | user-flow | 18 | 10.13 | 18.38 | 10.5 | 18.5 | 10.5 | 18.5 | 10.5 |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| workspace-default-relative-rebuild-visible-tree | user-flow | 74.41 | 66.61 | 74.72 | 66.74 | 74.88 | 67.22 | 74.88 | 67.22 |
